	...
	Combining 
		...
		API_GATEWAY	UPDATED BRIDGE DP	4 MONTHS AGO
		ABSTRACT_DOCUMENT	UPDATED	4 MONTHS AGO
		ABSTRACT_FACTORY	UPDATED	4 MONTHS AGO
		ADAPTER	UPDATED	4 MONTHS AGO
		AGGREGATOR_MICROSERVICES	UPDATED BRIDGE DP	4 MONTHS AGO
		ASYNC_METHOD_INVOCATION	UPDATED	11 DAYS AGO
		BALKING	UPDATED BRIDGE DP	4 MONTHS AGO
		BRIDGE	UPDATED	4 MONTHS AGO
		BUILDER	UPDATED	4 MONTHS AGO
		BUSINESS_DELEGATE	UPDATED	4 MONTHS AGO
		CQRS	UPDATED	11 DAYS AGO
		CACHING	UPDATED	4 MONTHS AGO
		CALLBACK	UPDATED	4 MONTHS AGO
		CHAIN_OF_RESPONSIBILITY	UPDATED	4 MONTHS AGO
		COLLECTIONS	UPDATED	4 MONTHS AGO
		COMBINED	UPDATED	4 MONTHS AGO
		COMBINING	UPDATED	4 MONTHS AGO
		COMMAND	UPDATED	4 MONTHS AGO
		COMPOSITE	UPDATED	4 MONTHS AGO
		CONVERTER	UPDATED	11 DAYS AGO
		CURIOUSLY_RECURRING_TEMPLATE_PATTERN_(CRTP)	UPDATED	11 DAYS AGO
		DAO	UPDATED	11 DAYS AGO
		DATA_BUS	UPDATED	4 MONTHS AGO
		DATA_MAPPER	UPDATED	4 MONTHS AGO
		DATA_TRANSFER_OBJ	UPDATED	4 MONTHS AGO
		DECORATOR	UPDATED	4 MONTHS AGO
		DEPENDENCY_INJECTION	UPDATED	4 MONTHS AGO
		DOUBLE_CHECKED_LOCKING	UPDATED	4 MONTHS AGO
		DOUBLE_DISPATCH	UPDATED	4 MONTHS AGO
		DUCKS	UPDATED	4 MONTHS AGO
		EIP_AGGREGATOR	UPDATED	4 MONTHS AGO
		EIP_WIRE_TAP	UPDATED	4 MONTHS AGO
		EIP_SPLITTER	UPDATED	4 MONTHS AGO
		EVENT_AGGREGATOR	UPDATED	4 MONTHS AGO
		EVENT_ASYNCHRONOUS	UPDATED	4 MONTHS AGO
		EVENT_DRIVEN_ARCHITECTURE	UPDATED	4 MONTHS AGO
		EVENT_QUEUE	UPDATED	4 MONTHS AGO
		EVENT_SOURCING	UPDATED	4 MONTHS AGO
		EXECUTE_AROUND	UPDATED	4 MONTHS AGO
		EXTENSION_OBJECTS	UPDATED	4 MONTHS AGO
		FACADE	UPDATED	4 MONTHS AGO
		FACTORY	UPDATED	4 MONTHS AGO
		FACTORY_KIT	UPDATED	4 MONTHS AGO
		FEATURE_TOGGLE	UPDATED	4 MONTHS AGO
		FLUENT_INTERFACE	UPDATED	4 MONTHS AGO
		FLUX	UPDATED	4 MONTHS AGO
		FLY_WEIGHT	UPDATED	4 MONTHS AGO
		FRONT_CONTROLLER	UPDATED	4 MONTHS AGO
		GUARDED_SUSPENSION	UPDATED	4 MONTHS AGO
		HALF_SYNC_HALF_ASYNC	UPDATED	4 MONTHS AGO
		HEXAGONAL	UPDATED	4 MONTHS AGO
		INTERCEPTING_FILTER	UPDATED	4 MONTHS AGO
		INTERPRETER	UPDATED	4 MONTHS AGO
		ITERATOR	UPDATED	4 MONTHS AGO
		ITERENUM	UPDATED	4 MONTHS AGO
		LAYERS	UPDATED	4 MONTHS AGO
		LAZY_LOADING	UPDATED	4 MONTHS AGO
		MARKER	UPDATED	4 MONTHS AGO
		MEDIATOR	UPDATED	4 MONTHS AGO
		MEMENTO	UPDATED	4 MONTHS AGO
		MESSAGE_CHANNEL	UPDATED	4 MONTHS AGO
		MODEL_VIEW_CONTROLLER	UPDATED	4 MONTHS AGO
		MODEL_VIEW_PRESENTER	UPDATED	4 MONTHS AGO
		MODULE	UPDATED	4 MONTHS AGO
		MONAD	UPDATED	4 MONTHS AGO
		MONOSTATE	UPDATED	4 MONTHS AGO
		MULTITON	UPDATED	4 MONTHS AGO
		MUTE_IDIOM	UPDATED	4 MONTHS AGO
		MUTEX	UPDATED	4 MONTHS AGO
		NAKED_OBJECTS	UPDATED	4 MONTHS AGO
		NULL_OBJECT	UPDATED	4 MONTHS AGO
		OBJECT_MOTHER	UPDATED	4 MONTHS AGO
		OBJECT_POOL	UPDATED	4 MONTHS AGO
		OBSERVER	UPDATED	4 MONTHS AGO
		PAGE_OBJECT	UPDATED	4 MONTHS AGO
		PARTIAL_RESPONSE	UPDATED	4 MONTHS AGO
		POISON_PILL	UPDATED	4 MONTHS AGO
		PRIVATE_CLASS_DATA	UPDATED	4 MONTHS AGO
		PRODUCER_CONSUMER	UPDATED	4 MONTHS AGO
		PROMISE	UPDATED	4 MONTHS AGO
		PROPERTY	UPDATED	4 MONTHS AGO
		PROTOTYPE	UPDATED	4 MONTHS AGO
		PROXY	UPDATED	4 MONTHS AGO
		PUBLISH_SUBSCRIBE	UPDATED	4 MONTHS AGO
		QUEUE_LOAD_LEVELING	UPDATED	4 MONTHS AGO
		REACTOR	UPDATED	4 MONTHS AGO
		READER_WRITER_LOCK	UPDATED	4 MONTHS AGO
		REPOSITORY	UPDATED	4 MONTHS AGO
		RESOURCE_ACQUISITION_IS_INITIALIZATION	UPDATED	4 MONTHS AGO
		SEMAPHORE	UPDATED	4 MONTHS AGO
		SERVANT	UPDATED	4 MONTHS AGO
		SERVICE_LAYER	UPDATED	4 MONTHS AGO
		SERVICE_LOCATOR	UPDATED	4 MONTHS AGO
		SINGLETON	UPDATED	4 MONTHS AGO
		SPECIFICATION	UPDATED	4 MONTHS AGO
		STATE	UPDATED	4 MONTHS AGO
		STEPBUILDER	UPDATED	4 MONTHS AGO
		STRATEGY	UPDATED	4 MONTHS AGO
		TEMPLATE	UPDATED	4 MONTHS AGO
		THREAD_LOCAL_STORAGE(TLS)	UPDATED	4 MONTHS AGO
		THREAD_POOL	UPDATED	4 MONTHS AGO
		THROTTLING	UPDATED	4 MONTHS AGO
		TOLERANT_READER	UPDATED	4 MONTHS AGO
		TWIN	UPDATED	4 MONTHS AGO
		VALUE_OBJECT	UPDATED	4 MONTHS AGO
		VISITOR	UPDATED	4 MONTHS AGO
